...
app.post('/data', isAuthorized, (req, res) => {
    let data = req.body
...
app.get('/data/:id_pasien', isAuthorized, (req, res) => {
    let sql = `
        select * from pasien
...
app.put('/data/:id_pasien', isAuthorized, (req, res) => {
    let data = req.body
...
app.delete('/data/:id_pasien', isAuthorized, (req, res) => {
    let sql = `
        delete from pasien
        where id_pasien = '`+req.params.id_pasien+`'
        `
...
app.post('/kamar', isAuthorized, (req, res) => {
    let data = req.body
...
app.put('/kamar/:id_kamar', isAuthorized, (req, res) => {
    let data = req.body
...
app.delete('/kamar/:id_kamar', isAuthorized, (req, res) => {
    let sql = `
        delete from kamar
        where id_kamar = '`+req.params.id_kamar+`'
        `
...
//TRANSAKSI 
app.post('/take',isAuthorized, (req, res) => {
    let data = req.body
...
//Menampilkan data 
app.get('/pasien/:id_pasien/kamar', isAuthorized, (req, res) => {
    db.query(`
...
//Edit Data
app.put('/kamar/:id/pasien', isAuthorized, (req, res) => {
    let data = req.body

    let sql = `
        update kamar_pasien
        set id_admin = '`+data.id_admin+`', id_kamar = '`+data.id_kamar+`', id_pasien = '`+data.id_pasien+`'
...
//Menghapus data
app.delete('/take/:id/:id_kamar',isAuthorized, (req, res) => {
    let data = req.body
